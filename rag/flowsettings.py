...
from libs.ktem.ktem.utils.lang import SUPPORTED_LANGUAGE_MAP
...
if config("KH_DOCSTORE_NAME") == 'lance':
    KH_DOCSTORE = {
        "__type__": "kotaemon.storages.LanceDBDocumentStore",
        "path": config("KH_DOCSTORE_LANCE_PATH"),
        "api_key": config("KH_DOCSTORE_LANCE_API_KEY")
    }
else:
    KH_DOCSTORE = {
...
if config("KH_VECTORSTORE_NAME") == 'qdrant':
    KH_VECTORSTORE = {
        "__type__": "kotaemon.storages.QdrantVectorStore",
        "url": config("KH_VECTORSTORE_QDRANT_PATH"),
        "api_key": config("KH_VECTORSTORE_QDRANT_API_KEY"),
