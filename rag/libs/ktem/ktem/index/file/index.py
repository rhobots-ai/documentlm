...
from sqlalchemy import JSON, Column, DateTime, Integer, String, UniqueConstraint, Boolean
...
class FileIndex(BaseIndex):
    ...
    def _setup_resources(self):
        ...
        if self.config.get("private", False):
            Source = type(
                ...
                (Base,),
                {
                    "__tablename__": f"core_datasource",
                    "id": Column(
                        String,
                        primary_key=True,
                    ...
                    "title": Column(String),
                    "data_type": Column(String, default='document'),
                    "file": Column(String),
                    ...
                    "is_created_via_platform": Column(Boolean, default=False)
                },
            )
        else:
            Source = type(
        ...
        Index = type(
            ...
            (Base,),
            {
                "__tablename__": f"core_datasourceindex",
        ...
        FileGroup = type(
            ...
            (Base,),
            {
                "__tablename__": f"core_filegroup",
                "id": Column(
                    String,
                    primary_key=True,
                    default=lambda: str(uuid.uuid4()),
    ...
    def get_retriever_pipelines(
        self, settings: dict, user_id: int, selected_ids: Any = None
